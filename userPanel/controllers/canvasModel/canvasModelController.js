...
.controller('canvasModelController',['$scope','$http', '$location','$window', 'canvasService',function($scope,$http, $location, $window, canvasService){
  ...
  $scope.masterModel = {};
  $scope.masterModel.ca_title  = '';
  $scope.masterModel.ca_desc  = '';
  $scope.masterModel.ca_model = '';
  $scope.masterModel.Question = $scope.canvasList;
  // $scope.masterModel.mo_list  = $scope.modelList;


  $scope.getModelList = function(){
    
    var modelList = canvasService.getModelList();
  ...
  $scope.viewData = function(response){
  ...
  $scope.selectedModel = function(model){
    ...
    $scope.masterModel.ca_model = model.moID;
    $scope.masterModel.Question = $scope.canvasList;
  }
  ...
  $scope.saveCanvas = function(){
    canvasService.saveCanvas($scope.masterModel);
  }

  $scope.viewPDF = function(responce){
    $window.open(baseURL+'/'+responce.pdf_report_url);
  }

  $scope.editResponce = function(responce){
    canvasService.editResponce(responce.ucID);
  }
